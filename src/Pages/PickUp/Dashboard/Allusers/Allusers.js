...
const Allusers = () => {
    const { data: users = [], refetch } = useQuery({
        queryKey: ['users'],
        queryFn: async () => {
            const res = await fetch('https://laptop-bazar-second-hand-server-assignment12.vercel.app/users');
    ...
    const handleMakeadmin = id => {
        fetch(`https://laptop-bazar-second-hand-server-assignment12.vercel.app/users/admin/${id}`, {
