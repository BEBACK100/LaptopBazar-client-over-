        ...
        <div>
            ...
            <div className='grid lg:grid-cols-2 gap-5 sm:grid-cols-1'>
                ...
                <div className="collapse w-80 mx-auto rounded-2xl">
                    ...
                    <div className="collapse-title bg-success text-primary-content peer-checked:bg-secondary peer-checked:text-secondary-content text-2xl">
                ...
                <div className="collapse w-80 mx-auto rounded-2xl mt-5">
                    <input type="checkbox" className="peer" />
                    <div className="collapse-title bg-success text-primary-content peer-checked:bg-orange-500 peer-checked:text-secondary-content text-2xl">
                        <h1><span className='text-3xl text-black  font-bold'>Question(02):</span>	How does prototypical inheritance work?</h1>
                    </div>
                    <div className="collapse-content bg-success text-primary-content peer-checked:bg-secondary peer-checked:text-secondary-content">
                        <h1 className='mx-auto'>
                ...
                <div className="collapse w-80 mx-auto my-6 rounded-2xl">
                    <input type="checkbox" className="peer" />
                    <div className="collapse-title bg-success text-primary-content peer-checked:bg-secondary peer-checked:text-secondary-content text-2xl">
                        <h1><span className='text-3xl text-black  font-bold'>Question(03):</span>What is a unit test? Why should we write unit tests? </h1>
                    </div>
                    <div className="collapse-content bg-success text-primary-content peer-checked:bg-secondary peer-checked:text-secondary-content">
                        <h1 className='mx-auto'>
                ...
                <div className="collapse w-80 mx-auto rounded-2xl mb-10">
                    <input type="checkbox" className="peer" />
                    <div className="collapse-title bg-success text-primary-content peer-checked:bg-lime-500 peer-checked:text-secondary-content text-2xl">
                        <h1><span className='text-3xl text-black font-bold'>Question(04):</span>React vs. Angular vs. Vue?</h1>
                    </div>
                    <div className="collapse-content bg-success text-primary-content peer-checked:bg-indigo-800 peer-checked:text-secondary-content">
                        <h1 className='mx-auto'>
