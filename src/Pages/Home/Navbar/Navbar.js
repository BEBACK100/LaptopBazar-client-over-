...

        {
            user?.uid ?
                <>
                    ...
                    <Link to='/dashboard'><button className="btn btn-outline  btn-success">Dashboard</button></Link>
                </>
    ...
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <Link className="btn btn-ghost normal-case text-3xl text-success font-bold">Laptop-Bazar</Link><span className='text-lg font-bold text-success'>(Second-hand)</span></div>
